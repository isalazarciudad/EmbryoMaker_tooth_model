...
do ick=1,ncels
  ...
  !!!!! PROLIFOVERALL MOD: WE HAVE TO INCLUDE NOISE INTO THE CELL CYCLE PROGRESSION IF WE DON'T WANT THAT CLONES OF CELLS DIVIDE SYNCHRONOUSLY
  !call random_number(a) ; a=a*2.0d0-1.00d0
  !print*,"ONE"
  !print*,"s-pre",s
  !s=s+s*a
  !print*,"a",a,"s",s
