...
!ic_load=3
  ...
  select case(ic_load)
    ...
    case(7);  call epidermal_organ_in_tooth_bud_s2_small_2D
...
subroutine transform
  ...
  do i=1,nd
    if (gex(i,1)>0.1d0)then
      if(node(i)%z<-0.20d0)then
        gex(i,23)=0d0
      else
        gex(i,23)=1d0
      end if
    elseif (gex(i,2)>0.1d0)then
      if(node(i)%z<-0.20d0)then
        gex(i,4)=0d0 ; gex(i,6)=1.0d0
        gex(i,23)=0d0
      else
        gex(i,4)=0d0 ; gex(i,5)=0d0 ; gex(i,7)=1.0d0
        gex(i,23)=1d0
      end if
    else if (gex(i,3)>0.1d0)then
        gex(i,6)=0d0 ; gex(i,7)=0d0 ; gex(i,15)=1d0
    end if
  end do
