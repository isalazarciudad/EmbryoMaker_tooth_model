...
!print*,"arrowselection",arrowselection
  ...
  if(flag(12)==1.or.flag(13)==1)then   
    ...
    do i=1,nd
      ...
      if ((flag(30)==1.and.node(i)%tipus<3).or.(flag(31)==1.and.gex(i,3)>0.1d0).or.(flag(32)==1.and.gex(i,2)>0.1d0))then
        ...
        if (a>=mix.and.a<=mx.and.b>=miy.and.b<=my.and.c>=miz.and.c<=mz) then
          do j=1,nneigh(i)
            ic=neigh(i,j)
            if(ic<i) cycle
            if((node(i)%tipus<3.and.gex(ic,3)>0.1).or.(node(ic)%tipus<3.and.gex(i,3)>0.1)) cycle
            ...
            if((flag(12)==1.and.node(i)%icel/=node(ic)%icel).or.(flag(13)==1 .and. node(i)%icel==node(ic)%icel))then
              ...
              if((flag(30)==1.and.node(ic)%tipus<3).or.(flag(31)==1.and.gex(ic,3)>epsilod).or.&
                                                         &(flag(32)==1.and.gex(ic,2)>epsilod))then
