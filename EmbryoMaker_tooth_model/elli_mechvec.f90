...
!  call glutInit(1,loc(pgm))
  ...
  call glClearColor(0.5_glclampf, 0.5_glclampf, 0.5_glclampf, 1.0_glclampf)
  call glLightfv(gl_light0, gl_diffuse, (/1.,1.,1.,1./))
  call glLightfv(gl_light0, gl_position, (/1.5,-.5,2.0,0.0/))
  !call glLightfv(gl_light0, gl_position, (/-1.5,-.5,0.0,0.0/))
  !call glLightfv(gl_light0, gl_position, (/-5.0,.0,2.0,0.0/))
  !call glLightfv(gl_light0, gl_position, (/10.0,0.0,-20.0,0.0/))
